...
| consult                | Consultant                                          | Independent or staff scientist |
| research_officer       | Research officer                                    | Independent or staff scientist |
| independent_researcher | Independent researcher                              | Independent or staff scientist |
...
| phd_stud               | student_phd  | PhD student                     |
...
| consult                | staff_res    | Independent or staff researcher |
| research_officer       | staff_res    | Independent or staff researcher |
| independent_researcher | staff_res    | Independent or staff researcher |
| retired_scientist      | ret_sci      | Retired scientist               |
...
k.data <- k.data %>% mutate(other_acad = tolower(other_acad)) %>%
  mutate(other_acad = recode(other_acad,
    ...
    "enseignant-chercher (vacataire)" = "",
    "technicien de laboratoire" = "research_assist",
    "enseignant vacataire,consultant" = "",
    "médecin" = "",
    ...
    "cco  (biologiste preleveur)" = "",
    "chef de volet conservation"  = "",
    ...
    "chef de projet dans la conservation"  = "",
    "responsable ictc" = "",
    "en recherche de finacement"  = "",
    "i still study at the undergraduate level" = "",
    "recently graduate"  = "postgrad",
    "ministre"  = "instructor",
    "manager en éducation environnementale" = "",
    ...
    "enseignant vacataire-informaticien" = "",
    "responsable laborat" = "",
    "responsable d'hygiène" = "",
    "enseignante vacataire" = "",
    "entrepreneur" = "consult",
    "responsable production et environnement" = "",
    "respo admin personnel et juridique" = "",
    "cadre dans un projet de développement" = "",
