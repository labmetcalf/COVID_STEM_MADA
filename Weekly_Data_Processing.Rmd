...
#### Section 2.1 | Removing incomplete survyes or ineligible respondents
...
```{r 2.02.3C, echo = FALSE}
dfx1 <- k.data %>% select(`_index`, challenge_opport:`challenge_opport/none`, other_challenge_opport)
