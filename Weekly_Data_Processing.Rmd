...
df.stress <- k.data %>% select(year_of_birth:acad, stress_delaywork:stress_relation, stress_moneyemplo:stress_anxiety) %>% 
  drop_na() %>%
  filter(gender != "other_notsay")
...
df.hhc <- k.data %>% 
  ...
  select(index, year_of_birth, gender, region, acad, 
         nb_room,
         hh_member_count,
         close_contact) %>%
  ...
  melt(id.vars = c("index", "index_hh", "year_of_birth", "gender", "region", "acad", 
